# Pipeline de Calidad de Datos y Gestión de Excepciones
...
Para solucionar esto de forma robusta, se implementó un **Data Quality Pipeline** dentro de nuestro script principal de ETL (`src/data_cleaning.py`).
...
2.  **Base Oficial (`transacciones`):** Los datos que pasan las reglas o que pueden ser imputados y salvados mediante lógica de negocio conforman la base oficial, también conocida como la **Fuente Única de Verdad o Single Source of Truth**.
...
-   **Registros limpios de la Base Oficial:** **5,000 registros**. Listos para ser consumidos por Power BI.

> [!IMPORTANT]
> **Integración con Gobierno de Datos (Rol del Data Steward):**
> La tabla de excepciones debe ser consumida periódicamente por un **Data Steward**. Su responsabilidad será investigar estos 398 registros anómalos, corregirlos en el ERP/sistema origen y permitir que vuelvan a fluir correctamente hacia la base oficial en la siguiente ejecución del ETL.
